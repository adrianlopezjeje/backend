...
The repository is organized in several directories:
 ...
 - `/test`: contains the code of the test application.
   ...
   `package-lock.json`: describes the exact tree of models that will be generated in the node_modules directory after running the command "npm install" and is automatically generated when npm modifies the package.json.    
   `README.md`: this file.
